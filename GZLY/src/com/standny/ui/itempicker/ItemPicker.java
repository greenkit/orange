...
package com.standny.ui.itempicker;
...
public class ItemPicker extends LinearLayout {
    ...
    public ItemPicker(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(
        		attrs, R.styleable.ItemPicker, 0, 0);
        
        int start = a.getInt(R.styleable.ItemPicker_start, -1);
        int end = a.getInt(R.styleable.ItemPicker_end, -1);
        int displayedValueId = a.getResourceId(R.styleable.ItemPicker_displayedValue, -1);
        String[] displayedValue = (displayedValueId > -1) ? 
        		getResources().getStringArray(displayedValueId) :
        		null;
        
        int incrementBackground = a.getResourceId(R.styleable.ItemPicker_incrementBackground, -1);
        int decrementBackground = a.getResourceId(R.styleable.ItemPicker_decrementBackground, -1);
        int incrementSrc = a.getResourceId(R.styleable.ItemPicker_incrementSrc, -1);
        int decrementSrc = a.getResourceId(R.styleable.ItemPicker_decrementSrc, -1);
        int editTextBackground = a.getResourceId(R.styleable.ItemPicker_editTextBackground, -1);;
        ...
        /*TextWatcher textChanger=new TextWatcher(){
        ...
        //mText.addTextChangedListener(textChanger);
        ...
        if(start > -1 && end > -1) {
        	if(displayedValue != null) {
        		setRange(start, end, displayedValue);
        	}
        	else {
        		setRange(start, end);
        	}
        ...
        int current = a.getInt(R.styleable.ItemPicker_current, -1);
        if(current > -1)
        	setCurrent(current);
        
        int speed = a.getInt(R.styleable.ItemPicker_speed, -1);
        if(speed > -1)
        	setSpeed(speed);
        a.recycle();
    }
